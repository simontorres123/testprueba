...
<html lang="es">
  ...
  <body > 
    <section style="position: relative; width: 400px; height: 480px;
        background-color: rgba(15, 70, 17, 0); border-radius: 20%;">
      <h1  align="center" style="position: relative; color: rgb(51, 50, 62); top: 100px;
        left:-50px; font-style: arial;">Bienvenido a: </h1>
      <img  align="center" style="position: relative;top: 80px; left: 260px;" class="img-responsive" src="http://conedmex.com/images/conedlogo%20copy.png" alt="" width="40%" height="25%" top="15%" }>
      <br>
      <br>
      <p  align="center" style="position: relative; left: -20%; color: rgb(51, 50, 62); top: 50px;">
      Hola,
      ...
      <section align="center" style="position: relative; height: 13%; width: 50%;
     top: 40px ; left: 160px !important; border-radius: 10%;">
        <ul style="position: relative; top: 10px; ">
          <a  size="50" style="color:black; position: relative; left:50px;" title="Ingresar a la página" href="{{url()}}/base/{{$data['emails']}}/token/{{$data['token']}}" >Confirmar mi cuenta</a>
        </ul>
